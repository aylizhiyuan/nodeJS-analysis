...
/*buf4.write("智游",0,3,'utf8');
// []
console.log(buf4.toString());
buf4.write('游',3,3,'utf8');
console.log(buf4.toString());*/
...
let buf8 = buf7.slice(2,6);//切割的意思，从2的位置截取到6的位置
console.log(buf8);
buf8.fill(4);
console.log(buf7);//这个是一个浅拷贝，要注意！！！！

/**
 * string_decoder
 * 它的出现是为了解决乱码问题
 */
let buf9 = Buffer.from('智游培训');
...
console.log(sd.write(buf10));//智
console.log(sd.write(buf11));//游
